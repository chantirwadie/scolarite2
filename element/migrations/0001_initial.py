    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pourcentage_element', models.FloatField(max_length=50)),
                ('pourcentage_controle', models.FloatField(max_length=50)),
                ('pourcentage_module', models.FloatField(max_length=50)),
                ('professeur', models.IntegerField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Module_element', to='module.module')),
            ],
        ),
    ]
